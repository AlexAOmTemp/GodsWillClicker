...
public struct RewardData
{
    ...
    public RewardData(Sprite image, string description, CallBack statIncrement) =>
        (RewardImage, Description, StatIncrement, CounterIncrement, Name, Value) =
        (image, description, statIncrement, null, AbilityNames.Armor, 1);

    public RewardData(Sprite image, string description, CallBackWithName counterIncrement, AbilityNames name) =>
        (RewardImage, Description, StatIncrement, CounterIncrement, Name, Value) =
        (image, description, null, counterIncrement, name, 1);
